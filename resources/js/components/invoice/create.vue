        ...
        <header>
          <div class="row">
            ...
            <div class="col company-details">
              <h2 class="name">
                <a target="_blank" href="#">MoliExpress</a>
              </h2>
              <div>MoliExpress Place</div>
              <div>(123) 456-789</div>
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
              ...
              <tr v-for="(invoiceItem, key) in invoiceItems" :key="key">
                ...
                <td class="unit">{{invoiceItem.product.price}}MAD</td>
                <td class="qty">{{invoiceItem.quantity}}MAD</td>
